...
let initialBoard = [  [PIECE.BLACK_ROOK,PIECE.BLACK_KNIGHT,PIECE.BLACK_BISHOP,PIECE.BLACK_QUEEN,PIECE.BLACK_KING,PIECE.BLACK_BISHOP,PIECE.BLACK_KNIGHT,PIECE.BLACK_ROOK],
...
export class GameState {
    constructor() {
        ...
        this.hltPositions = [...Array(8)].map(e => Array(8).fill(false))
        this.moveHistory = []
    }
}